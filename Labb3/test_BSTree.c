...
void testTree(BSTree tree)
{
    ...
    // Avkommentera rad 108-118 om du vid borttagning av nod med två barn väljer det minsta i
    // höger delträd som ersättare (11 ersätter då 9 i det här testet), jämför dina utskrifter
    // av trädet med de utskrifter som visar hur trädet bör se ut. Om du behöver kan du justera
    // mellanslagen i utskrifterna så att formateringen ser bra ut i din konsoll. */
    /*
    printf("\nPreorder\nYour tree:    ");
    ...
    */
    ...
    // Avkommentera rad 125-134 om du vid borttagning av nod med två barn väljer det största i
    // vänster delträd som ersättare (8 ersätter då 9 i det här testet), jämför dina utskrifter
    // av trädet med de utskrifter som visar hur trädet bör se ut. Om du behöver kan du justera
    // mellanslagen i utskrifterna så att formateringen ser bra ut i din konsoll.
    /*
    printf("\nPreorder\nYour tree:    ");
...
void menuTree(BSTree tree)
{
    ...
    do
    {
        ...
        case 5:
            ...
            break;
        case 6:
            printf("Number of nodes in tree: %d", numberOfNodes(tree));
            break;
        case 7:
            printf("Actual depth of tree: %d\n", depth(tree));
